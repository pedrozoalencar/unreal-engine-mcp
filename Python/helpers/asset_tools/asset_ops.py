...
def register_asset_tools(mcp, get_connection):
    ...
    def asset_list(
        ...
        return get_connection().send_command("asset_list", params)
    ...
    def asset_find(
        ...
        return get_connection().send_command("asset_find", params)

    @mcp.tool()
    def asset_get_info(asset_path: str) -> Dict[str, Any]:
        """Get detailed info about an asset: class, package, references, is dirty."""
        return get_connection().send_command("asset_get_info", {"asset_path": asset_path})
    ...
    def asset_duplicate(
        ...
        return get_connection().send_command("asset_duplicate", {
    ...
    def asset_rename(
        ...
        return get_connection().send_command("asset_rename", {
            "source_path": source_path, "destination_path": destination_path
        })
    ...
    def asset_delete(asset_path: str) -> Dict[str, Any]:
        ...
        return get_connection().send_command("asset_delete", {"asset_path": asset_path})

    @mcp.tool()
    def asset_exists(asset_path: str) -> Dict[str, Any]:
        """Check if an asset exists at the given path."""
        return get_connection().send_command("asset_exists", {"asset_path": asset_path})

    @mcp.tool()
    def asset_save(asset_path: str) -> Dict[str, Any]:
        """Save a specific asset."""
        return get_connection().send_command("asset_save", {"asset_path": asset_path})
