...
class UEResponse:
    ...
    @staticmethod
    def ok(data: Any = None, tool: str = "", warnings: List[str] = None, duration_ms: float = 0) -> Dict:
        resp = {
            "ok": True,
            "data": data or {},
            "meta": {"tool": tool, "duration_ms": round(duration_ms, 1)}
        }
        if warnings:
    ...
    @staticmethod
    def error(code: str, message: str, tool: str = "", details: Any = None, retryable: bool = False) -> Dict:
        return {
            "ok": False,
